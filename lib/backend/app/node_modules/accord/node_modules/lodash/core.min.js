...
;(function () {
  function n(n) {
    ...
    }return 2 & u || (i = l && pn.call(n, "__wrapped__"), f = c && pn.call(t, "__wrapped__"), !i && !f) ? !!a && (r = R(n, t, r, e, u, o), o.pop(), r) : (i = i ? n.value() : n, f = f ? t.value() : t, r = r(i, f, e, u, o), o.pop(), r);
  }function _(n) {
    return typeof n == "function" ? n : null == n ? Y : ((typeof n === "undefined" ? "undefined" : _typeof(n)) == "object" ? m : r)(n);
  }function j(n, t) {
    return n < t;
  }function d(n, t) {
    var r = -1,
    ...
    var t = _n(n);return function (r) {
      var e = t.length;if (null == r) return !e;for (r = Object(r); e--;) {
        var u = t[e];if (!(u in r && b(n[u], r[u], nn, 3))) return false;
      }return true;
    };
  }function O(n, t) {
    ...
    var i = n.length,
        c = t.length;if (i != c && !(2 & u && c > i)) return false;for (var c = -1, f = true, a = 1 & u ? [] : nn; ++c < i;) {
      var l = n[c],
          p = t[c];if (void 0 !== nn) {
        f = false;break;
      }if (a) {
    ...
    if (f != a && !i) return false;for (var l = f; l--;) {
      ...
      var p = c[l],
          s = n[p],
          h = t[p];if (void 0 !== nn || s !== h && !r(s, h, e, u, o)) {
        a = false;break;
      }i || (i = "constructor" == p);
    ...
    var e = n ? n.length : 0;r = typeof r == "number" ? 0 > r ? jn(e + r, 0) : r : 0, r = (r || 0) - 1;for (var u = t === t; ++r < e;) {
    ...
    var r;if (typeof t != "function") throw new TypeError("Expected a function");return n = Tn(n), function () {
    ...
    var u = qn(r),
        o = v(r, u);null != e || H(r) && (o.length || !u.length) || (e = r, r = n, n = this, o = v(r, qn(r)));var i = !(H(e) && "chain" in e && !e.chain),
  ...
  var mn = function (n, t) {
    ...
    return function (t, r, e) {
      var u = Object(t);if (!U(t)) {
        var o = _(r);t = qn(t), r = function r(n) {
          return o(u[n], n, u);
        };
      }return r = n(t, r, e), -1 < r ? u[o ? t[r] : r] : nn;
    };
  }(function (n, t, r) {
    var e = n ? n.length : 0;if (!e) return -1;r = null == r ? 0 : Tn(r), 0 > r && (r = jn(e + r, 0));n: {
    ...
    var e = n ? n.length : 0;return r = r === nn ? e : +r, e ? A(n, null == t ? 0 : +t, r) : [];
    ...
    var t = n ? n.length : 0;return t ? n[t - 1] : nn;
  }, o.max = function (n) {
  ...
  }(), { chain: false }), o.VERSION = "4.16.4", mn("pop join replace reverse split push shift sort splice unshift".split(" "), function (n) {
    var t = (/^(?:replace|split)$/.test(n) ? String.prototype : an)[n],
      ...
      var n = arguments;if (e && !this.__chain__) {
        var u = this.value();return t.apply(Sn(u) ? u : [], n);
